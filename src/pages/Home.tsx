...
import { WeatherWidget, MarketWidget, MapWidget, NewsWidget } from "./HomeSections";
    ...
    <div className={styles.page}>
      ...
      <div className={styles.hero}>
        ...
        <h1 className={styles.heroTitle}>
          চাষিদের জন্য<br />
          <span className={styles.heroHL}>স্মার্ট ও নির্ভরযোগ্য</span>
        </h1>
        <p className={styles.heroSub}>
          বাংলাদেশের কৃষকদের জন্য তথ্য-প্রযুক্তি নির্ভর কৃষি সেবা — ফসলের রোগ চিহ্নিত করুন,
          সার ও বীজের পরামর্শ নিন।
        </p>
      ...
      <div className={styles.liveSection}>
        <div className={styles.liveSectionTitle}>
          <span className={styles.liveDot} /> লাইভ ড্যাশবোর্ড
        </div>

        {/* Weather */}
        <div className={styles.widgetLabel}>🌤️ আবহাওয়া — ঢাকা</div>
        <WeatherWidget />
        ...
        {/* News */}
        <div className={styles.widgetLabel}>📰 সর্বশেষ কৃষি সংবাদ</div>
        <NewsWidget />
      </div>
      ...
      <div className={styles.testimonial}>
        ...
        <p className={styles.testQuote}>
          "কৃষি AI ব্যবহার করে আমার ধান ফসলের রোগ দ্রুত সনাক্ত করতে পেরেছি
          এবং সঠিক সময়ে ব্যবস্থা নিতে পেরেছি। ফলন আগের চেয়ে অনেক ভালো।"
        </p>
      ...
      <div className={styles.metrics}>
        {[["১১.৫%","ফলন বৃদ্ধি"],["৮.৭ টি","পরামর্শ"],["১৪%","খরচ সাশ্রয়"],["৫১ মি+","ব্যবহারকারী"]].map(([v,l],i)=>(
          <div key={i} className={styles.metricBox}>
            ...
            <span className={styles.metricLbl}>{l}</span>
          </div>
        ))}
      </div>
