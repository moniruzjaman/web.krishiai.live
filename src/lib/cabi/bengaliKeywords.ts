...
export const BENGALI_KEYWORD_MAP: Record<string, string> = {
  ...
  'ছিদ্র/চিবানো': 'chewing marks holes insect',
 ...
 */
export function translateBengaliToEnglish(bengaliText: string): string {
 ...
 */
export function translateSymptomsToEnglish(bengaliSymptoms: string[]): string {
