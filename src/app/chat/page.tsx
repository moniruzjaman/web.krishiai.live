...
const WELCOME_MESSAGE: Message = {
  ...
  role: "assistant",
  content:
    "স্বাগতম! আমি কৃষি AI সহকারী। আপনার কৃষি সংক্রান্ত যেকোনো প্রশ্ন করুন — ফসলের রোগ, সারের মাত্রা, আবহাওয়া পূর্বাভাস বা বাজার মূল্য সম্পর্যে জানতে চাইলে আমি সাহায্য করতে পারি।",
