...
const QUIZ_QUESTIONS = [
  ...
  {
    id: 5,
    question: "বাংলাদেশে সবচেয়ে বেশি চাষ হওয়া ধানের জাত কোন মৌসুমের?",
    options: ["আউশ", "আমন", "বোরো", "কাচরি"],
    correctIndex: 2,
    explanation: "বাংলাদেশে বোরো মৌসুমের ধান সবচেয়ে বেশি উৎপাদিত হয়। বোরো ধান শীতকালে চাষ হয় এবং সেচ নিয়ন্ত্রিত পরিবেশে ফলন বেশি পাওয়া যায়।",
  },
  {
    id: 6,
    question: "ধানের জমিতে ইউরিয়া সার কোন সময়ে প্রয়োগ করা উচিত?",
    options: ["শুধু রোপণের সময়", "রোপণের ২১-২৫ দিন পর ও কালি ফুটার সময়", "ফসল কাটার আগে", "যেকোনো সময়"],
    correctIndex: 1,
    explanation: "ইউরিয়া সার দুই বা তিন কিস্তে প্রয়োগ করা উচিত — রোপণের ২১-২৫ দিন পর (মাঝে কিস্ত) এবং কালি ফুটার সময় (শেষ কিস্ত)। এতে সারের ব্যবহার দক্ষ হয়।",
  },
  {
    id: 7,
    question: "বাংলাদেশে সেচের প্রধান উৎস কী?",
    options: ["নদীর পানি", "ভূ-গর্ভস্থ পানি", "বৃষ্টির পানি", "পুকুরের পানি"],
    correctIndex: 1,
    explanation: "বাংলাদেশে সেচের প্রধান উৎস ভূ-গর্ভস্থ পানি। বোরো মৌসুমে গভীর ও অগভীর নলকূপ থেকে সেচ দেওয়া হয়। তবে ভূ-গর্ভস্থ পানির মাত্রা কমছে যা উদ্বেগজনক।",
  },
  {
    id: 8,
    question: "পাটের সবচেয়ে ক্ষতিকারক পোকা কোনটি?",
    options: ["মাজরা", "সেমিলুপার", "গাছফড়িং", "মাকড়"],
    correctIndex: 1,
    explanation: "পাটের সবচেয়ে ক্ষতিকারক পোকা হলো সেমিলুপার। এটি পাটের পাতা খেয়ে ফসলের ব্যাপক ক্ষতি করে। সময়মতো পোকানাশক প্রয়োগ ও আলোর ফাঁদ ব্যবহার করে দমন করা যায়।",
  },
  {
    id: 9,
    question: "বাংলাদেশে রবি মৌসুম কোন মাসগুলোতে পড়ে?",
    options: ["জানুয়ারি-মে", "নভেম্বর-ফেব্রুয়ারি", "জুন-সেপ্টেম্বর", "মার্চ-জুন"],
    correctIndex: 1,
    explanation: "বাংলাদেশে রবি মৌসুম নভেম্বর থেকে ফেব্রুয়ারি পর্যন্ত চলে। এ সময়ে শীতকালীন ফসল যেমন গম, সরিষা, আলু, পেঁয়াজ ইত্যাদি চাষ করা হয়।",
  },
  {
    id: 10,
    question: "বাংলাদেশের কোন মাটি ধান চাষের জন্য সবচেয়ে উপযোগী?",
    options: ["বেলে মাটি", "পলি মাটি", "দোআশ মাটি", "পাথরে মাটি"],
    correctIndex: 1,
    explanation: "পলি মাটি ধান চাষের জন্য সবচেয়ে উপযোগী। এই মাটিতে পানি ধারণ ক্ষমতা বেশি থাকে এবং পুষ্টি উপাদান সমৃদ্ধ। বাংলাদেশের বেশিরভাগ ধান ক্ষেত পলি মাটিতে অবস্থিত।",
  },
];
