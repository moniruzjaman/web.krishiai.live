...
const HARDCODED_CROPS: HardcodedCrop[] = [
  ...
  // ── অতিরিক্ত শস্য (Additional Grains) ──
  {
    icon: "🌾", name: "ধান (আউশ)", season: "খরিফ", region: "ময়মনসিংহ, রংপুর, দিনাজপুর",
    variety: ["ব্রি ধান-১৪", "ব্রি ধান-৪২", "ব্রি ধান-৬৫"],
    duration: "১০০-১২০ দিন", yieldPer: "২.০-৩.৫ টন/হেক্টর",
    seedRate: "৪৫-৫০ কেজি/হেক্টর", spacing: "২০×১৫ সেমি",
    fertilizer: "ইউরিয়া ১৫০, টিএসপি ৯০, এমওপি ৭০, জিপসাম ৩৫ কেজি/হেক্টর",
    diseases: ["ব্লাস্ট", "খোল পোড়া", "ব্যাকটেরিয়াল ব্লাইট"],
    pests: ["গাছফড়িং", "গণ্ডারি", "হিসপা"],
    tips: "বর্ষার আগে বপন সম্পন্ন করুন। কম সার প্রয়োগ করুন। আগাছা পরিষ্কার রাখুন।",
  },
  // ── তেলবীজ (Oilseeds) ──
  {
    icon: "🌻", name: "তিল", season: "খরিফ/রবি", region: "রাজশাহী, চাঁপাইনবাবগঞ্জ, দিনাজপুর",
    variety: ["বারি তিল-৩", "বারি তিল-৪", "স্থানীয় জাত"],
    duration: "৭৫-৯০ দিন", yieldPer: "০.৮-১.২ টন/হেক্টর",
    seedRate: "৪-৫ কেজি/হেক্টর", spacing: "৩০×১০ সেমি",
    fertilizer: "ইউরিয়া ৮০, টিএসপি ১০০, এমওপি ৬০, জিপসাম ৪০ কেজি/হেক্টর",
    diseases: ["লিফ কার্ল", "ফিলোডি", "অ্যানথ্রাকনোজ"],
    pests: ["মাজরা", "ক্যাটারপিলার", "লিফ হপার"],
    tips: "আগাছামুক্ত মাটিতে বপন। ফুল আসার সময় সেচ দিন।",
  },
  {
    icon: "🌻", name: "সূর্যমুখী", season: "রবি", region: "রংপুর, দিনাজপুর, রাজশাহী",
    variety: ["হাইসান-৩৩", "প্রোসান-৬০", "স্থানীয় জাত"],
    duration: "৯০-১১০ দিন", yieldPer: "১.৫-২.৫ টন/হেক্টর",
    seedRate: "৮-১০ কেজি/হেক্টর", spacing: "৬০×৩০ সেমি",
    fertilizer: "ইউরিয়া ১৮০, টিএসপি ১৫০, এমওপি ১০০, জিপসাম ৫০ কেজি/হেক্টর",
    diseases: ["রাস্ট", "লিফ স্পট", "হেড রট"],
    pests: ["মাজরা", "ক্যাপসুল বোরার", "হেড ক্যাটারপিলার"],
    tips: "পূর্ণ রোদে চাষ করুন। মাথা ভরাট হলে সংগ্রহ করুন।",
  },
  {
    icon: "🥜", name: "চীনাবাদাম", season: "খরিফ/রবি", region: "রংপুর, চাঁপাইনবাবগঞ্জ, নোয়াখালী",
    variety: ["বারি চীনাবাদাম-১", "বারি চীনাবাদাম-২", "ডাকা-১"],
    duration: "১১০-১৩০ দিন", yieldPer: "১.৫-২.৫ টন/হেক্টর",
    seedRate: "৮০-১০০ কেজি/হেক্টর", spacing: "৩০×১৫ সেমি",
    fertilizer: "ইউরিয়া ৪০, টিএসপি ১২০, এমওপি ৮০, জিপসাম ২০০ কেজি/হেক্টর",
    diseases: ["টিক্কা রোগ", "রাস্ট", "অ্যাসপারজিলাস ফ্ল্যাস"],
    pests: ["লিফ মাইনার", "আফিড", "স্পটেড ক্যাটারপিলার"],
    tips: "জিপসাম বেশি দিন। মাটি চারদিকে তুলে দিন। শুকনো মাটিতে সংগ্রহ।",
  },
  // ── ডাল (Pulses) ──
  {
    icon: "🫘", name: "মুগ ডাল", season: "খরিফ/রবি", region: "রাজশাহী, চাঁপাইনবাবগঞ্জ, যশোর",
    variety: ["বারি মুগ-৫", "বারি মুগ-৬", "বিনা মুগ-৫"],
    duration: "৬০-৭০ দিন", yieldPer: "০.৮-১.২ টন/হেক্টর",
    seedRate: "২০-২৫ কেজি/হেক্টর", spacing: "৩০×১০ সেমি",
    fertilizer: "ইউরিয়া ৩০, টিএসপি ১০০, এমওপি ৫০, জিপসাম ৪০ কেজি/হেক্টর",
    diseases: ["মোজাইক", "পাউডারি মিলডিউ", "স্টেম ফ্লাই"],
    pests: ["অ্যাফিড", "পড বোরার", "হোয়াইট ফ্লাই"],
    tips: "রাইজোবিয়াম ইনোকুলেন্ট বীজে প্রয়োগ। শস্যের সাথে মিশ্র চাষ করতে পারেন।",
  },
  {
    icon: "🫘", name: "খেসারি", season: "রবি", region: "রাজশাহী, চাঁপাইনবাবগঞ্জ, যশোর",
    variety: ["বারি খেসারি-১", "বারি খেসারি-২", "বিনা খেসারি-১"],
    duration: "৯০-১১০ দিন", yieldPer: "০.৮-১.৫ টন/হেক্টর",
    seedRate: "৩৫-৪০ কেজি/হেক্টর", spacing: "৩০×৫ সেমি",
    fertilizer: "ইউরিয়া ৩০, টিএসপি ১০০, এমওপি ৫০, জিপসাম ৪০ কেজি/হেক্টর",
    diseases: ["রাস্ট", "অ্যাসকোকাইটা ব্লাইট", "রুট রট"],
    pests: ["অ্যাফিড", "পড বোরার", "কাটওয়ার্ম"],
    tips: "ধানের পর খেসারি চাষ করুন। কম সার লাগে।",
  },
  {
    icon: "🫘", name: "ছোলা", season: "রবি", region: "রাজশাহী, চাঁপাইনবাবগঞ্জ, দিনাজপুর",
    variety: ["বারি ছোলা-৫", "বারি ছোলা-৬", "হাইব্রিড"],
    duration: "১০০-১২০ দিন", yieldPer: "১.০-১.৮ টন/হেক্টর",
    seedRate: "৩০-৪০ কেজি/হেক্টর", spacing: "৩০×১০ সেমি",
    fertilizer: "ইউরিয়া ৩৫, টিএসপি ১২০, এমওপি ৬০, জিপসাম ৫০ কেজি/হেক্টর",
    diseases: ["অ্যাসকোকাইটা ব্লাইট", "বোট্রাইটিস গ্রে মোল্ড", "ফুসারিয়াম উইল্ট"],
    pests: ["পড বোরার", "অ্যাফিড", "কাটওয়ার্ম"],
    tips: "জীবাণুমুক্ত বীজ ব্যবহার করুন। ফুল আসার সময় সেচ দিন।",
  },
  // ── সবজি (Vegetables) ──
  {
    icon: "🫛", name: "লাউ", season: "খরিফ/রবি", region: "সর্বজনীন",
    variety: ["বারি লাউ-১", "বারি লাউ-২", "হাইব্রিড"],
    duration: "৯০-১১০ দিন", yieldPer: "২০-৩০ টন/হেক্টর",
    seedRate: "৩-৪ কেজি/হেক্টর", spacing: "২০০×১০০ সেমি",
    fertilizer: "ইউরিয়া ১৮০, টিএসপি ১৫০, এমওপি ১২০, জিপসাম ৪৫ কেজি/হেক্টর",
    diseases: ["ডাউনি মিলডিউ", "পাউডারি মিলডিউ", "মোজাইক"],
    pests: ["ফল মাছি", "অ্যাফিড", "রেড স্পাইডার মাইট"],
    tips: "মাচা তৈরি করলে ফলন বেশি হয়। নিয়মিত সেচ দিন।",
  },
  {
    icon: "🎃", name: "মিষ্টি কুমড়া", season: "খরিফ/রবি", region: "সর্বজনীন",
    variety: ["বারি কুমড়া-১", "বারি কুমড়া-২", "স্থানীয় জাত"],
    duration: "৯০-১১০ দিন", yieldPer: "১৫-২৫ টন/হেক্টর",
    seedRate: "৪-৫ কেজি/হেক্টর", spacing: "২০০×১০০ সেমি",
    fertilizer: "ইউরিয়া ১৬০, টিএসপি ১৪০, এমওপি ১১০, জিপসাম ৪০ কেজি/হেক্টর",
    diseases: ["ডাউনি মিলডিউ", "মোজাইক", "অ্যানথ্রাকনোজ"],
    pests: ["ফল মাছি", "রেড স্পাইডার মাইট", "বিটল"],
    tips: "মাচা তৈরি করুন। পরাগায়নে মৌমাছি সাহায্য করে।",
  },
  {
    icon: "🥦", name: "ফুলকপি", season: "রবি", region: "সর্বজনীন",
    variety: ["বারি ফুলকপি-১", "বারি ফুলকপি-২", "হাইব্রিড"],
    duration: "৭০-৯০ দিন", yieldPer: "২০-৩৫ টন/হেক্টর",
    seedRate: "৩০০-৪০০ গ্রাম/হেক্টর", spacing: "৬০×৪৫ সেমি",
    fertilizer: "ইউরিয়া ২৫০, টিএসপি ১৭০, এমওপি ১৩০, জিপসাম ৪৫ কেজি/হেক্টর",
    diseases: ["ব্ল্যাক রট", "ক্লাব রুট", "ডাউনি মিলডিউ"],
    pests: ["ডায়মন্ড ব্যাক মথ", "ক্যাবেজ হেড বোরার", "অ্যাফিড"],
    tips: "বীজতলায় চারা তৈরি করুন। মাথা ঢাকার জন্য পাতা ভাঁজ করুন।",
  },
  {
    icon: "🥒", name: "করলা", season: "খরিফ/রবি", region: "সর্বজনীন",
    variety: ["বারি করলা-১", "বারি করলা-২", "হাইব্রিড"],
    duration: "৭০-৯০ দিন", yieldPer: "১০-১৫ টন/হেক্টর",
    seedRate: "৪-৫ কেজি/হেক্টর", spacing: "১৫০×৬০ সেমি",
    fertilizer: "ইউরিয়া ১৬০, টিএসপি ১৪০, এমওপি ১১০, জিপসাম ৪০ কেজি/হেক্টর",
    diseases: ["পাউডারি মিলডিউ", "ডাউনি মিলডিউ", "মোজাইক"],
    pests: ["ফল মাছি", "অ্যাফিড", "মাইট"],
    tips: "মাচা তৈরি করুন। নিয়মিত ফল সংগ্রহ করুন।",
  },
  {
    icon: "🥒", name: "ঝিঙ্গা", season: "খরিফ/রবি", region: "সর্বজনীন",
    variety: ["স্থানীয় জাত", "হাইব্রিড"],
    duration: "৬০-৭৫ দিন", yieldPer: "৮-১২ টন/হেক্টর",
    seedRate: "৩-৪ কেজি/হেক্টর", spacing: "১৫০×৬০ সেমি",
    fertilizer: "ইউরিয়া ১৫০, টিএসপি ১৩০, এমওপি ১০০, জিপসাম ৪০ কেজি/হেক্টর",
    diseases: ["পাউডারি মিলডিউ", "মোজাইক"],
    pests: ["ফল মাছি", "অ্যাফিড", "বিটল"],
    tips: "মাচা তৈরি করুন। ছোট অবস্থায় ফল সংগ্রহ করুন।",
  },
  {
    icon: "🥒", name: "কাকরল", season: "খরিফ/রবি", region: "সর্বজনীন",
    variety: ["স্থানীয় জাত", "হাইব্রিড"],
    duration: "৬৫-৮০ দিন", yieldPer: "৮-১২ টন/হেক্টর",
    seedRate: "৩-৪ কেজি/হেক্টর", spacing: "১৫০×৬০ সেমি",
    fertilizer: "ইউরিয়া ১৫০, টিএসপি ১৩০, এমওপি ১০০, জিপসাম ৪০ কেজি/হেক্টর",
    diseases: ["ডাউনি মিলডিউ", "পাউডারি মিলডিউ"],
    pests: ["ফল মাছি", "অ্যাফিড", "মাইট"],
    tips: "মাচা তৈরি করুন। সবুজ অবস্থায় সংগ্রহ করুন।",
  },
  {
    icon: "🥔", name: "মিষ্টি আলু", season: "খরিফ", region: "রাজশাহী, যশোর, কুষ্টিয়া",
    variety: ["বারি মিষ্টি আলু-১", "বারি মিষ্টি আলু-২", "স্থানীয় জাত"],
    duration: "১০০-১২০ দিন", yieldPer: "১৫-২৫ টন/হেক্টর",
    seedRate: "কাণ্ড বিভাজন", spacing: "৬০×২৫ সেমি",
    fertilizer: "ইউরিয়া ১২০, টিএসপি ১৫০, এমওপি ১২০, জিপসাম ৪৫ কেজি/হেক্টর",
    diseases: ["স্কার্ফ", "ব্ল্যাক রট", "ফুসারিয়াম উইল্ট"],
    pests: ["হোয়াইট গ্রাব", "ওয়্যারওয়ার্ম", "অ্যাফিড"],
    tips: "বেলে দোআঁশ মাটিতে চাষ করুন। আগাছা পরিষ্কার রাখুন।",
  },
  {
    icon: "🌿", name: "ওলকচু", season: "খরিফ", region: "সর্বজনীন",
    variety: ["স্থানীয় জাত"],
    duration: "১৮০-২১০ দিন", yieldPer: "১০-১৫ টন/হেক্টর",
    seedRate: "কাণ্ড বিভাজন", spacing: "৯০×৬০ সেমি",
    fertilizer: "ইউরিয়া ১০০, টিএসপি ১২০, এমওপি ১০০, জিপসাম ৪০ কেজি/হেক্টর",
    diseases: ["রাইজোম রট", "লিফ ব্লাইট"],
    pests: ["কাণ্ড ছিদ্রকারী", "অ্যাফিড"],
    tips: "ছায়াযুক্ত জায়গায় চাষ। প্রচুর জৈব সার দিন।",
  },
  {
    icon: "🌿", name: "কচু", season: "খরিফ", region: "সর্বজনীন",
    variety: ["স্থানীয় জাত", "পানি কচু"],
    duration: "১৮০-২৪০ দিন", yieldPer: "১২-১৮ টন/হেক্টর",
    seedRate: "কাণ্ড বিভাজন", spacing: "৬০×৪৫ সেমি",
    fertilizer: "ইউরিয়া ১০০, টিএসপি ১১০, এমওপি ৯০, জিপসাম ৪০ কেজি/হেক্টর",
    diseases: ["রাইজোম রট", "লিফ ব্লাইট", "ফুসারিয়াম উইল্ট"],
    pests: ["কাণ্ড ছিদ্রকারী", "মাইট"],
    tips: "ছায়াযুক্ত জায়গায় চাষ। জৈব সার বেশি দিন।",
  },
  {
    icon: "🫛", name: "শিম", season: "খরিফ/রবি", region: "সর্বজনীন",
    variety: ["বারি শিম-১", "বারি শিম-২", "হাইব্রিড"],
    duration: "৬৫-৮০ দিন", yieldPer: "৮-১২ টন/হেক্টর",
    seedRate: "২৫-৩০ কেজি/হেক্টর", spacing: "৬০×৩০ সেমি",
    fertilizer: "ইউরিয়া ৪০, টিএসপি ১০০, এমওপি ৬০, জিপসাম ৪০ কেজি/হেক্টর",
    diseases: ["রাস্ট", "অ্যানথ্রাকনোজ", "মোজাইক"],
    pests: ["পড বোরার", "অ্যাফিড", "হোয়াইট ফ্লাই"],
    tips: "মাচা তৈরি করুন। নিয়মিত শিম সংগ্রহ করুন।",
  },
  {
    icon: "🫛", name: "বরবটি", season: "খরিফ/রবি", region: "সর্বজনীন",
    variety: ["বারি বরবটি-১", "বারি বরবটি-২", "স্থানীয় জাত"],
    duration: "৬০-৭৫ দিন", yieldPer: "৬-১০ টন/হেক্টর",
    seedRate: "১৫-২০ কেজি/হেক্টর", spacing: "১০০×৩০ সেমি",
    fertilizer: "ইউরিয়া ৩৫, টিএসপি ৯০, এমওপি ৫৫, জিপসাম ৩৫ কেজি/হেক্টর",
    diseases: ["রাস্ট", "মোজাইক", "অ্যানথ্রাকনোজ"],
    pests: ["পড বোরার", "অ্যাফিড", "মাইট"],
    tips: "মাচা তৈরি করুন। নিয়মিত ফল সংগ্রহ করুন।",
  },
  {
    icon: "🌿", name: "হলুদ", season: "খরিফ", region: "রাঙ্গামাটি, খাগড়াছড়ি, রাজশাহী",
    variety: ["বারি হলুদ-১", "বারি হলুদ-২", "স্থানীয় জাত"],
    duration: "২১০-২৪০ দিন", yieldPer: "১০-১৮ টন/হেক্টর",
    seedRate: "১৫০০-২০০০ কেজি/হেক্টর", spacing: "৪৫×২০ সেমি",
    fertilizer: "ইউরিয়া ২২০, টিএসপি ১৬৫, এমওপি ১২০, জিপসাম ৫৫ কেজি/হেক্টর",
    diseases: ["রাইজোম রট", "লিফ স্পট", "ফুসারিয়াম উইল্ট"],
    pests: ["শুট বোরার", "রাইজোম ফ্লাই", "হোয়াইট গ্রাব"],
    tips: "ছায়াযুক্ত জায়গায় চাষ করুন। মালচিং করুন। জৈব সার বেশি দিন।",
  },
  // ── ফল (Fruits) ──
  {
    icon: "🍇", name: "লিচু", season: "খরিফ", region: "দিনাজপুর, রংপুর, বগুড়া",
    variety: ["বোম্বাই", "চায়না", "মুজাফফরপুরী"],
    duration: "৫-৭ বছর", yieldPer: "৫-৮ টন/হেক্টর",
    seedRate: "জায়গায় জায়গায় ১ গাছ", spacing: "১০×১০ মিটার",
    fertilizer: "ইউরিয়া ৮০০, টিএসপি ৬০০, এমওপি ৫০০, জিপসাম ৩০০ কেজি/হেক্টর",
    diseases: ["অ্যানথ্রাকনোজ", "লিফ ব্লাইট", "ফল পচা"],
    pests: ["ফল মাছি", "মাজরা", "হিসপা"],
    tips: "ফুল আসার আগে সেচ বন্ধ রাখুন। ফল ধরার পর নিয়মিত সেচ দিন।",
  },
  {
    icon: "🫐", name: "জাম", season: "খরিফ", region: "সর্বজনীন",
    variety: ["কালা জাম", "বাংলা জাম", "পর্তুগিজ জাম"],
    duration: "৪-৬ বছর", yieldPer: "৮-১২ টন/হেক্টর",
    seedRate: "জায়গায় জায়গায় ১ গাছ", spacing: "৮×৮ মিটার",
    fertilizer: "ইউরিয়া ৬০০, টিএসপি ৫০০, এমওপি ৪০০, জিপসাম ২৫০ কেজি/হেক্টর",
    diseases: ["অ্যানথ্রাকনোজ", "লিফ স্পট", "ফল পচা"],
    pests: ["ফল মাছি", "অ্যাফিড", "বিটল"],
    tips: "বর্ষায় চারা রোপণ করুন। নিয়মিত ছাঁটাই করুন।",
  },
  {
    icon: "🍈", name: "কাঁঠাল", season: "খরিফ", region: "গাজীপুর, টাঙ্গাইল, ময়মনসিংহ",
    variety: ["খাজুর কাঁঠাল", "গালা কাঁঠাল", "স্থানীয় জাত"],
    duration: "৪-৫ বছর", yieldPer: "১০-১৫ টন/হেক্টর",
    seedRate: "জায়গায় জায়গায় ১ গাছ", spacing: "১০×১০ মিটার",
    fertilizer: "ইউরিয়া ৭০০, টিএসপি ৫৫০, এমওপি ৪৫০, জিপসাম ৩০০ কেজি/হেক্টর",
    diseases: ["ফল পচা", "লিফ স্পট", "গোমোজা"],
    pests: ["ফল মাছি", "বিটল", "মাকড়"],
    tips: "বড় গর্তে চারা রোপণ। প্রচুর জৈব সার দিন।",
  },
  {
    icon: "🍍", name: "আনারস", season: "খরিফ", region: "ময়মনসিংহ, গাজীপুর, টাঙ্গাইল",
    variety: ["কুয়েন স্ল্যান্ডার", "গোলাপ কাঁচা", "স্থানীয় জাত"],
    duration: "১৪-১৮ মাস", yieldPer: "১৫-২৫ টন/হেক্টর",
    seedRate: "সাকার বা ক্রাউন", spacing: "৬০×৩০ সেমি",
    fertilizer: "ইউরিয়া ৪৫০, টিএসপি ৩৫০, এমওপি ৩৫০, জিপসাম ২০০ কেজি/হেক্টর",
    diseases: ["হার্ট রট", "লিফ স্পট", "রুট রট"],
    pests: ["মিলিবাগ", "নিমাটোড", "স্কেল ইনসেক্ট"],
    tips: "অ্যাসিড মাটিতে ভালো হয়। মালচিং করুন। ফুল আনার হরমোন ব্যবহার করতে পারেন।",
  },
  {
    icon: "🥥", name: "সুপারি", season: "সারা বছর", region: "চট্টগ্রাম, কক্সবাজার, সিলেট",
    variety: ["স্থানীয় জাত", "হাইব্রিড"],
    duration: "৫-৭ বছর", yieldPer: "২-৪ টন/হেক্টর",
    seedRate: "জায়গায় জায়গায় ১ গাছ", spacing: "২.৭×২.৭ মিটার",
    fertilizer: "ইউরিয়া ৫০০, টিএসপি ৪০০, এমওপি ৪০০, জিপসাম ২০০ কেজি/হেক্টর",
    diseases: ["বাডি রট", "লিফ স্পট", "স্টেম ব্লিডিং"],
    pests: ["রাইনোসেরাস বিটল", "মিলিবাগ", "মাইট"],
    tips: "ছায়াযুক্ত জায়গায় চাষ। প্রচুর পানি দিন।",
  },
  {
    icon: "🥥", name: "নারিকেল", season: "সারা বছর", region: "বরগুনা, পটুয়াখালী, ভোলা",
    variety: ["দেশী নারিকেল", "বাম্নি পাম", "হাইব্রিড"],
    duration: "৫-৭ বছর", yieldPer: "৬-১০ হাজার নারিকেল/হেক্টর",
    seedRate: "জায়গায় জায়গায় ১ গাছ", spacing: "৭.৫×৭.৫ মিটার",
    fertilizer: "ইউরিয়া ৮০০, টিএসপি ৬০০, এমওপি ৮০০, জিপসাম ৪০০ কেজি/হেক্টর",
    diseases: ["বাডি রট", "গোমোজা", "লিফ স্পট"],
    pests: ["রাইনোসেরাস বিটল", "মিলিবাগ", "র‍্যাট"],
    tips: "লবণাক্ত মাটিতে ভালো হয়। গোড়ায় মাটি তুলে দিন।",
  },
  {
    icon: "🍃", name: "পান", season: "সারা বছর", region: "রাজশাহী, নাটোর, বরিশাল",
    variety: ["মিঠা পান", "সাদা পান", "বাংলা পান"],
    duration: "২-৩ বছর", yieldPer: "১০-১৫ লাখ পাতা/হেক্টর",
    seedRate: "লতা কটিং", spacing: "৬০×৬০ সেমি",
    fertilizer: "ইউরিয়া ৩০০, টিএসপি ২৫০, এমওপি ২০০, জিপসাম ১৫০ কেজি/হেক্টর",
    diseases: ["ফুট রট", "লিফ স্পট", "ব্যাকটেরিয়াল লিফ ব্লাইট"],
    pests: ["মাইট", "অ্যাফিড", "স্লাগ"],
    tips: "ছায়াযুক্ত বেডে চাষ। নিয়মিত সেচ ও পরিচর্যা দিন।",
  },
  {
    icon: "🍋", name: "লেবু", season: "সারা বছর", region: "সর্বজনীন",
    variety: ["গোল লেবু", "এলাচি লেবু", "কাগজি লেবু"],
    duration: "৩-৪ বছর", yieldPer: "১৫-২৫ টন/হেক্টর",
    seedRate: "জায়গায় জায়গায় ১ গাছ", spacing: "৪×৪ মিটার",
    fertilizer: "ইউরিয়া ৬০০, টিএসপি ৪৫০, এমওপি ৪০০, জিপসাম ৩০০ কেজি/হেক্টর",
    diseases: ["ক্যানকার", "গোমোজা", "ট্রিস্টেজা"],
    pests: ["লিফ মাইনার", "অ্যাফিড", "স্কেল ইনসেক্ট"],
    tips: "ফল ধরার সময় অতিরিক্ত সার দিন। নিয়মিত ছাঁটাই করুন।",
  },
  {
    icon: "🍊", name: "কমলা", season: "শীত", region: "সিলেট, চট্টগ্রাম, পাহাড়ি এলাকা",
    variety: ["বাংলা কমলা", "চায়না কমলা", "স্থানীয় জাত"],
    duration: "৪-৫ বছর", yieldPer: "১০-১৮ টন/হেক্টর",
    seedRate: "জায়গায় জায়গায় ১ গাছ", spacing: "৫×৫ মিটার",
    fertilizer: "ইউরিয়া ৬৫০, টিএসপি ৫০০, এমওপি ৪৫০, জিপসাম ৩০০ কেজি/হেক্টর",
    diseases: ["ক্যানকার", "গোমোজা", "স্ক্যাব"],
    pests: ["লিফ মাইনার", "অ্যাফিড", "ফল মাছি"],
    tips: "পাহাড়ি ঢালে চাষ ভালো। শীতের শুরুতে ফল সংগ্রহ করুন।",
  },
  {
    icon: "🍈", name: "পেঁপে", season: "সারা বছর", region: "সর্বজনীন",
    variety: ["বারি পেঁপে-১", "রাধুনী", "স্থানীয় জাত"],
    duration: "৮-১০ মাস", yieldPer: "৪০-৬০ টন/হেক্টর",
    seedRate: "৫০০ গ্রাম বীজ/হেক্টর", spacing: "২×২ মিটার",
    fertilizer: "ইউরিয়া ৪৫০, টিএসপি ৩৫০, এমওপি ৩০০, জিপসাম ২০০ কেজি/হেক্টর",
    diseases: ["রিংস্পট ভাইরাস", "ফুট রট", "অ্যানথ্রাকনোজ"],
    pests: ["মিলিবাগ", "হোয়াইট ফ্লাই", "ফল মাছি"],
    tips: "পুরুষ ও স্ত্রী গাছ চিহ্নিত করুন। নিয়মিত ফল সংগ্রহ করুন।",
  },
  // ── অর্থকরী ফসল (Cash Crops) ──
  {
    icon: "🍵", name: "চা", season: "সারা বছর", region: "সিলেট, চট্টগ্রাম, পাহাড়ি এলাকা",
    variety: ["বিটি১", "বিটি২", "বিটি৬"],
    duration: "৩-৫ বছর", yieldPer: "১.৫-২.৫ টন তৈরি চা/হেক্টর",
    seedRate: "কটিং/চারা", spacing: "১.২×০.৬ মিটার",
    fertilizer: "ইউরিয়া ১৫০, টিএসপি ১০০, এমওপি ১০০, জিপসাম ৫০ কেজি/হেক্টর",
    diseases: ["ব্লাইট", "রাস্ট", "হরমোনিস"],
    pests: ["টি মস্কিটো", "রেড স্পাইডার মাইট", "টি জাব"],
    tips: "ছায়াযুক্ত ঢালে চাষ। নিয়মিত ছাঁটাই করুন।",
  },
  {
    icon: "☁️", name: "তুলা", season: "খরিফ", region: "রংপুর, দিনাজপুর, বগুড়া",
    variety: ["বিনা তুলা-১", "সিবি-১", "সিবি-৭"],
    duration: "১৫০-১৮০ দিন", yieldPer: "১.৫-২.৫ টন/হেক্টর",
    seedRate: "১৫-২০ কেজি/হেক্টর", spacing: "৬০×৩০ সেমি",
    fertilizer: "ইউরিয়া ১৮০, টিএসপি ১৫০, এমওপি ১০০, জিপসাম ৫০ কেজি/হেক্টর",
    diseases: ["বোল রট", "অ্যাঙ্গুলার লিফ স্পট", "ব্লাইট"],
    pests: ["বোলওয়ার্ম", "অ্যাফিড", "জাব পোকা"],
    tips: "হাইব্রিড জাত ব্যবহার করুন। সময়মতো বপন ও সংগ্রহ।",
  },
  {
    icon: "🎋", name: "আখ", season: "খরিফ/রবি", region: "রাজশাহী, নাটোর, যশোর",
    variety: ["আইএসডি-৩৬", "আইএসডি-৩৯", "আইএসডি-৪০"],
    duration: "৩৬০-৪২০ দিন", yieldPer: "৭০-১০০ টন/হেক্টর",
    seedRate: "৪০,০০০-৫০,০০০ সেট/হেক্টর", spacing: "৯০×৬০ সেমি",
    fertilizer: "ইউরিয়া ৩৫০, টিএসপি ২৫০, এমওপি ২০০, জিপসাম ১০০ কেজি/হেক্টর",
    diseases: ["রেড রট", "স্মাট", "পোকার বোরার"],
    pests: ["স্টেম বোরার", "টপ বোরার", "হোয়াইট গ্রাব"],
    tips: "গোড়ায় মাটি তুলে দিন। পাতা শুকালে আখ কাটুন।",
  },
  {
    icon: "🚬", name: "তামাক", season: "রবি", region: "রংপুর, কুড়িগ্রাম, লালমনিরহাট",
    variety: ["বিটি-১২০", "বিটি-১২১", "স্থানীয় জাত"],
    duration: "১২০-১৫০ দিন", yieldPer: "১.৫-২.৫ টন/হেক্টর",
    seedRate: "০.৫ কেজি বীজ/হেক্টর", spacing: "৬০×৪৫ সেমি",
    fertilizer: "ইউরিয়া ৩০০, টিএসপি ২৫০, এমওপি ২০০, জিপসাম ৮০ কেজি/হেক্টর",
    diseases: ["ব্লাইট", "মোজাইক", "ব্যাকটেরিয়াল উইল্ট"],
    pests: ["অ্যাফিড", "হোয়াইট ফ্লাই", "কাটওয়ার্ম"],
    tips: "বীজতলায় চারা তৈরি। পাতা হলুদ হলে সংগ্রহ।",
  },
  // ── মসলা (Spices) ──
  {
    icon: "🌿", name: "ধনিয়া", season: "রবি", region: "সর্বজনীন",
    variety: ["বারি ধনিয়া-১", "বারি ধনিয়া-২", "স্থানীয় জাত"],
    duration: "৬০-৭৫ দিন", yieldPer: "১.০-১.৫ টন/হেক্টর",
    seedRate: "১০-১৫ কেজি/হেক্টর", spacing: "৩০×১০ সেমি",
    fertilizer: "ইউরিয়া ১২০, টিএসপি ১০০, এমওপি ৮০, জিপসাম ৩৫ কেজি/হেক্টর",
    diseases: ["পাউডারি মিলডিউ", "ব্লাইট", "স্টেম রট"],
    pests: ["অ্যাফিড", "হোয়াইট ফ্লাই", "কাটওয়ার্ম"],
    tips: "সময়মতো বপন। পাতা সবুজ থাকতে সংগ্রহ করুন।",
  },
  {
    icon: "🌿", name: "জিরা", season: "রবি", region: "রাজশাহী, চাঁপাইনবাবগঞ্জ, নাটোর",
    variety: ["বারি জিরা-১", "বারি জিরা-২", "স্থানীয় জাত"],
    duration: "১১০-১৩০ দিন", yieldPer: "০.৫-০.৮ টন/হেক্টর",
    seedRate: "৫-৭ কেজি/হেক্টর", spacing: "৩০×১০ সেমি",
    fertilizer: "ইউরিয়া ৮০, টিএসপি ১০০, এমওপি ৬০, জিপসাম ৪০ কেজি/হেক্টর",
    diseases: ["ব্লাইট", "অ্যালটারনেরিয়া লিফ স্পট", "ফুসারিয়াম উইল্ট"],
    pests: ["অ্যাফিড", "থ্রিপস", "কাটওয়ার্ম"],
    tips: "হালকা বেলে মাটিতে ভালো হয়। সময়মতো বপন (নভেম্বর)।",
  },
  {
    icon: "🪵", name: "দারুচিনি", season: "সারা বছর", region: "চট্টগ্রাম, পাহাড়ি এলাকা",
    variety: ["সিলোন দারুচিনি", "চায়নিজ দারুচিনি"],
    duration: "৩-৪ বছর", yieldPer: "২-৪ টন ছাল/হেক্টর",
    seedRate: "চারা রোপণ", spacing: "৩×৩ মিটার",
    fertilizer: "ইউরিয়া ৪০০, টিএসপি ৩০০, এমওপি ২৫০, জিপসাম ১৫০ কেজি/হেক্টর",
    diseases: ["লিফ স্পট", "স্টেম ক্যানকার"],
    pests: ["বিটল", "ক্যাটারপিলার"],
    tips: "পাহাড়ি ঢালে চাষ। ২-৩ বছর পর ছাল সংগ্রহ।",
  },
];
